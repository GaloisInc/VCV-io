...
def oracleImpl {proto : MsgTransmissionProtocol ProbComp Msg SendK RecvK} (sendk : SendK) :
    QueryImpl (unifSpec + Soracle proto) (StateT (Env proto.Ms) ProbComp) :=
